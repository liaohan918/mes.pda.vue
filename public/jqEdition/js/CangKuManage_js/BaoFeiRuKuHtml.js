...
//	$.ajax({
//		url: app.API_URL_HEADER + '/BaoFeiRuKu/GetBillNoList',
//		data: {
//			date: billDate
//		},
//		dataType: "json",
...
function GetNoFinishBarcodeCount(BillNo) {
	$.ajax({
		async: false,
		url: app.API_URL_HEADER + '/BaoFeiRuKu/GetNoFinishBarcodeCount',
		data: {
			BillNo: BillNo
		},
		dataType: "json",
...
function ReturnInStockKW() {
	...
	$.ajax({
		async: false,
		url: app.API_URL_HEADER + '/BaoFeiRuKu/ReturnInStockKW',
		data: {
			LoginID: user_id,
			KuWei: KuWei,
			BillNo: BillNo,
...
function GetInfoFromBarCode(BarCode, isDefault) {
	$.ajax({
		async: false,
		url: app.API_URL_HEADER + '/BaoFeiRuKu/GetInfoFromBarCode',
		data: {
			//BillNo: BillNo,
			BarCode: BarCode,
			isDefault: isDefault
