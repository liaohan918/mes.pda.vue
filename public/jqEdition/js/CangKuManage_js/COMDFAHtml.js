...
function GetBillNoList() {
	$.ajax({
		url: app.API_URL_HEADER + '/COMDFA/GetBillNoList',
		data: {
			//date: billDate
...
function GetMaterialList() {
	$.ajax({
		url: app.API_URL_HEADER + '/COMDFA/GetMaterialList',
		data: {
...
function GetBarCodeList(TMMC) {
	...
	$.ajax({
		url: app.API_URL_HEADER + '/COMDFA/GetBarCodeList',
		data: {
			TMMC:TMMC,
			BillNo: document.getElementById('BillNo').value
		},
...
function GetStorageLocation(materialID) {
	DataGridClearn('#gridKWList');
	$.ajax({
		url: app.API_URL_HEADER + '/COMDFA/GetStorageLocation',
		data: {
...
function DowithBarcode(BarCode) {
	...
	$.ajax({
		async: false,
		url: app.API_URL_HEADER + '/COMDFA/DoBarcode',
		data: {
			LoginID: user_id,
