...
function GetBillNoList() {
	$.ajax({
		url: app.API_URL_HEADER + '/QCK_WOMDAF/GetBillNoList',
		data: {
			//date: billDate
...
function GetMaterialList() {
	$.ajax({
		url: app.API_URL_HEADER + '/QCK_WOMDAF/GetMaterialList',
		data: {
			BillType:'5403',
...
function GetBarCodeList(TMMC) {
	...
	$.ajax({
		url: app.API_URL_HEADER + '/QCK_WOMDAF/GetBarCodeList',
		data: {
			TMMC:TMMC,
			BillType:'5403',
			BillNo: document.getElementById('BillNo').value
...
function GetStorageLocation(materialID) {
	DataGridClearn('#gridKWList');
	$.ajax({
		url: app.API_URL_HEADER + '/QCK_WOMDAF/GetStorageLocation',
		data: {
...
function DowithBarcode(BarCode) {
	...
	$.ajax({
		async: false,
		url: app.API_URL_HEADER + '/QCK_WOMDAF/DoBarcode',
		data: {
			LoginID: user_id,
			CurBillType:'5403',
